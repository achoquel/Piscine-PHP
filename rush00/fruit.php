...
if (!isset($_SESSION['panier'])) {
  ...
  {
    $items = [];
    $q = "SELECT id_item, name_item, description, link_img, price, stock FROM item WHERE type_id = 1";
...
<html>
  ...
  <body>
    ...
    <div class="content">
      <h1 class="indextxt">Catalogue des fruits</h1><br>
      <div class="fetl">
    ...
    <?php } ?>
    <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == 1):?>
        <a href="create_article.php?type=1" class="linkbox">
